...
if __name__ == '__main__':
    ...
    img = cv2.imread('/home/jacksparrow/Pictures/test_img.png',cv2.IMREAD_UNCHANGED) # Read the test img
    img = rgba2rgb(img)
    ...
    if( lines is None):
        ...
        for line in lines:
            x1, y1, x2, y2 = line[0]
            cv2.line(dmy, (x1, y1), (x2, y2), (255, 255, 255), 5)
